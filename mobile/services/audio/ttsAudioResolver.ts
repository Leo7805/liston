...
export function getVoiceName(lang: LanguageCodeType): VoiceNameType {
  switch (lang) {
    ...
    case LanguageCode.Taiwan:
      return config.voices.zh;
    case LanguageCode.Japanese:
      return config.voices.jp;
    case LanguageCode.Korean:
      return config.voices.ko;
    case LanguageCode.French:
      return config.voices.fr;
    case LanguageCode.German:
      return config.voices.de;
    case LanguageCode.Spanish:
      return config.voices.es;
    case LanguageCode.Italian:
      return config.voices.it;
    case LanguageCode.Russian:
      return config.voices.ru;
    case LanguageCode.Thai:
      return config.voices.th;
    case LanguageCode.Brazil:
      return config.voices.ptBr;
    case LanguageCode.Portugal:
      return config.voices.ptPt;
    default:
