...
import { type VoiceNameType } from '@/global/constants/azure-tts-voices';

/**
 * TTS API wrapper: resolves configured voices and returns generated audio as a Uint8Array.
 */
...
/**
 * Generates speech audio for given text and voice, returning a Uint8Array.
 */
export async function generateTtsSpeech({
  ...
  const res = await fetch(`${ENV.API_BASE_URL}/tts`, {
    method: 'POST',
    headers: {
